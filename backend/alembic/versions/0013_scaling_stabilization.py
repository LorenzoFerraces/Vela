...
def upgrade() -> None:
    ...
    op.add_column(
        "scaling_policies",
        sa.Column(
            "scale_up_condition_since", sa.DateTime(timezone=True), nullable=True
        ),
    )
    op.add_column(
        "scaling_policies",
        sa.Column(
            "scale_down_condition_since", sa.DateTime(timezone=True), nullable=True
        ),
    )
    op.alter_column(
        "scaling_policies", "scale_up_stabilization_seconds", server_default=None
    )
    op.alter_column(
        "scaling_policies", "scale_down_stabilization_seconds", server_default=None
    )
