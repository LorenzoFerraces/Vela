/**
 * HTTP plumbing shared by the domain modules in this directory: base URL,
 * token storage, error mapping, fetch helpers, request deduplication /
 * in-memory TTL cache, and WebSocket URL resolution.
 *
...
// --- Shared domain types (used by more than one module above) ---
